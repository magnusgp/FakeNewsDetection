...
def train(config):
    ...
    print(r"{}/data/processed/dataset.pt".format(os.path.dirname(os.path.dirname(os.path.dirname(cwd)))))
    dataset = torch.load(r"{}/data/processed/dataset.pt".format(os.path.dirname(os.path.dirname(os.path.dirname(cwd)))))
